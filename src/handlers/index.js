...
const UserRoutes = require('./src/handlers/routes/user');
const EezlyAisles = require('./src/handlers/routes/eezly/aisles');
const EezlyItems = require('./src/handlers/routes/eezly/items');
const EezlyItemsImport = require('./src/handlers/routes/eezly/import');
const Reconciliation = require('./src/handlers/routes/eezly/reconciliation');
const MergingFilter = require('./src/handlers/routes/eezly/mergingFilter');
const Store = require('./src/handlers/routes/store/store');
const Import = require('./src/handlers/routes/store/import');
const StoreAisles = require('./src/handlers/routes/store/aisles');
const Admin = require('./src/handlers/routes/admin/admin');
const Cart = require('./src/handlers/routes/cart');
const Shopping = require('./src/handlers/routes/shopping/shopping');
const Favorite = require('./src/handlers/routes/favorite/favorite');
const Dashboard = require('./src/handlers/routes/dashboard/config');
