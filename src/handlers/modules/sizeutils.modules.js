...
exports.GetUnitType = exports.ScaleAndChangeUnits = void 0;
let ScaleAndChangeUnits = (amount, unit, targetSystem) => {
...
exports.ScaleAndChangeUnits = ScaleAndChangeUnits;
let GetUnitType = (unit) => {
    let normalizedUnit = unit.toLowerCase();
    // Define lists of units for each category
    let weightUnits = ["pounds", "lbs"]; // TODO @Mouhamed Ndiaye provide full list
    let volumeUnits = ["gallons", "liters"];
    let lengthUnits = ["meters", "centimeters"];
...
exports.default = {
    ScaleAndChangeUnits: exports.ScaleAndChangeUnits,
    GetUnitType: exports.GetUnitType,
};
