...
describe('/merging Items', () => {
    ...
    it('Get merging data for getEezlyAisles', () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, supertest_1.default)(serverPath)
            .get("/mergingFilter/getEezlyAisles?brand=&size=&store=2")
            .set('Authorization', 'Bearer ' + token);
        expect(res.body.data.length).toBeGreaterThan(1);
    }));
    it('Get merging data for getEezlyBrands', () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, supertest_1.default)(serverPath)
            .get("/mergingFilter/getEezlyBrands?eezly_aisle_id=&size=&store=2")
            .set('Authorization', 'Bearer ' + token);
        expect(res.body.data.length).toBeGreaterThan(1);
    }));
    it('Get merging data for getEezlyBrands with get request', () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, supertest_1.default)(serverPath)
            .get("/mergingFilter/getEezlySizes?eezly_aisle_id=19&brand=Coolibah")
            .set('Authorization', 'Bearer ' + token);
        expect(res.body.status).toBe(true);
    }));
    it('Get merging data for getEezlyBrands with post request', () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, supertest_1.default)(serverPath)
