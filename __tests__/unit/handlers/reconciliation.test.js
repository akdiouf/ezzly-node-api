...
describe('/reconcillation Items', () => {
    ...
    it('Get reconciliation for valid ID', () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, supertest_1.default)(serverPath)
            .get("/reconciliation?eezly_item_id=9003")
            .set('Authorization', 'Bearer ' + token);
        expect(res.body.status).toBe(true);
    }));
    it('Get reconciliation for in-valid ID', () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, supertest_1.default)(serverPath)
            .get("/reconciliation?eezly_item_id=-9003")
            .set('Authorization', 'Bearer ' + token);
        expect(res.body.status).toBe(false);
    }));
    it('Skip reconciliation for Valid ID', () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, supertest_1.default)(serverPath)
    ...
    it('Skip reconciliation for in-valid ID', () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, supertest_1.default)(serverPath)
            .post("/reconciliation/skip")
            .send({
            eezly_item_id: -1,
