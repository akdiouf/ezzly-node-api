...
describe('/Admin APIs', () => {
    ...
    it('Get user details with valid user id', () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, supertest_1.default)(serverPath)
            .get("/admin/getUserDetail?user_id=2")
            .set('Authorization', 'Bearer ' + token);
        expect(res.body.status).toBe(true);
    }));
    it('Get user details with in-valid user id', () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, supertest_1.default)(serverPath)
            .get("/admin/getUserDetail?user_id=-2")
            .set('Authorization', 'Bearer ' + token);
